          ...
          {Object.keys(User).length > 0 ? (
            <View style={styles.headerContent}>
              ...
              <Text style={styles.greetingText}>
                Hi, {User?.fullname ? User?.fullname : User.displayName} !
              </Text>
            </View>
          ) : (
            <View style={{position: 'relative', right: 20}}>
              <Image source={bookLogo} style={{width: 160, height: 30}} />
            </View>
          )}
          <View style={{flexDirection: 'row', gap: 12}}>
            ...
            {Object.keys(User).length > 0 && (
              <TouchableOpacity onPress={handleLogout}>
                <LogoutIcon name="logout" color="#2C5DD1" size={25} />
                <Text style={{color: '#2C5DD1', fontSize: 9}}>Logout</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
                  ...
                  <View
                    ...
                    {!more ? (
                      <TouchableOpacity onPress={handleMore}>
                        <Text style={{color: '#2C5DD1', paddingRight: 10}}>
                          More
                        </Text>
                      </TouchableOpacity>
                    ) : (
